...
class TestCompteCourant {
    ...
    public void testInstanceCompteCourant() {
        ...
        assertEquals(15200.56, compteCourant1.getSolde(), "Le solde après avoir crédité " + compteCourant1.getIntitule() + " n'est pas le bon.");
        compteCourant1.debiter(50.0);
        assertEquals(15150.56, compteCourant1.getSolde(), "Le solde après avoir débité " + compteCourant1.getIntitule() + " n'est pas le bon.");
